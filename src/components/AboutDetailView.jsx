        ...
        <AnimatePresence mode="wait">
          <motion.div key={detailType} variants={slideLeft} initial="hidden" animate="visible" exit="exit">
            ...
            <div className="glass-card" style={{ padding:'28px', marginBottom:'12px' }}>
              <div style={{ fontSize:'0.46rem', letterSpacing:'0.24em', color:'var(--cyan)', marginBottom:'10px' }}>
                {detail.title.toUpperCase()}
              </div>
              <h2 style={{ fontFamily:'Orbitron', fontSize:'clamp(1.6rem,3.5vw,2.5rem)', color:'var(--text-primary)', marginBottom:'16px', lineHeight:'1' }}>
                {detail.title}
              </h2>
              <p style={{ fontFamily:'Rajdhani', fontSize:'0.98rem', color:'var(--text-secondary)', lineHeight:'1.7' }}>
                {detail.content}
              </p>
            </div>
