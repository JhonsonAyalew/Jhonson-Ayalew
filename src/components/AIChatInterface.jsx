  ...
  return (
    <div
      ...
      style={{
        ...
        width: isMobile ? '100vw' : 'min(720px, 94vw)',
        zIndex: 200,
      }}
    >
      {/* ── EXPANDED STATE ── */}
        ...
        {isOpen && (
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 -12px 50px rgba(255,255,255,0.05), 0 -4px 20px rgba(0,0,0,0.5)',
              overflow: 'hidden',
            }}
          >
            {/* Top glow line */}
            <div style={{ height: '1px', background: 'linear-gradient(90deg, transparent, var(--primary-white), transparent)' }} />
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <div style={{
                  ...
                  boxShadow: isLoading ? '0 0 16px rgba(255,255,255,0.4)' : '0 0 8px rgba(255,255,255,0.15)',
              ...
              {recentMessages.map((msg, i) => (
                <div key={i} style={{
                  ...
                  <div style={{
                    ...
                    border: `1px solid ${msg.role === 'user' ? 'var(--border-glow)' : 'var(--border-subtle)'}`,
                    borderLeft: msg.role === 'assistant' ? '2px solid var(--primary-white)' : undefined,
              ...
              {isLoading && (
                <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                  ...
                  <div style={{ display: 'flex', gap: '5px', alignItems: 'center' }}>
                    {[0, 150, 300].map(d => (
                      <div key={d} style={{ width: '5px', height: '5px', borderRadius: '50%', background: 'var(--primary-white)', animation: `typeBounce 1.2s infinite ${d}ms` }} />
                    ))}
                  </div>
                </div>
              )}
                ...
                >
                  {SUGGESTIONS.map(s => (
                    <button key={s} onClick={() => handleSuggest(s)} data-cursor
                      ...
                      onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--border-glow)'; e.currentTarget.style.color = 'var(--text-light)'; e.currentTarget.style.background = 'rgba(255,255,255,0.08)'; }}
                      onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--border-subtle)'; e.currentTarget.style.color = 'var(--text-muted)'; e.currentTarget.style.background = 'rgba(255,255,255,0.04)'; }}
                    >{s}</button>
                  ))}
                </motion.div>
              )}
            ...
            <div style={{
              ...
              <input
                ...
                onKeyDown={handleKey}
                placeholder="Ask anything about Johnson..."
                disabled={isLoading}
                data-cursor
                style={{
                ...
                onFocus={e => { e.target.style.borderColor = 'var(--border-glow)'; e.target.style.boxShadow = '0 0 16px rgba(255,255,255,0.08)'; }}
        ...
        {!isOpen && (
          <motion.div
            ...
            style={{
              ...
              cursor: 'none',
              boxShadow: '0 -6px 30px rgba(255,255,255,0.04)',
              transition: 'box-shadow 0.3s',
              position: 'relative',
            }}
            onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 -6px 30px rgba(255,255,255,0.1)'; }}
            onMouseLeave={e => { e.currentTarget.style.boxShadow = '0 -6px 30px rgba(255,255,255,0.04)'; }}
          >
            {/* Top glow */}
            <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '1px', background: 'linear-gradient(90deg, transparent, var(--primary-white), transparent)' }} />
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '1px' }}>
                <span style={{ fontFamily: 'Outfit', fontWeight: '700', fontSize: '0.72rem', color: 'var(--text-light)' }}>
                  Johnson AI
                </span>
                <div style={{ width: '5px', height: '5px', borderRadius: '50%', background: 'var(--primary-white)', boxShadow: '0 0 6px rgba(255,255,255,0.5)', animation: 'statusBlink 2s ease-in-out infinite' }} />
              </div>
              <div style={{
