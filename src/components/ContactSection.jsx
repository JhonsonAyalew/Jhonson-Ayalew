...
const CONTACT_LINKS = [
  ...
  { label: 'LinkedIn',  value: 'in/jhonson-ayalew-a3738138b',                Icon: Linkedin, href: 'https://linkedin.com/in/jhonson-ayalew-a3738138b' },
  { label: 'Portfolio', value: 'portfolio-chi-seven-11.vercel.app',           Icon: Globe,    href: 'https://portfolio-chi-seven-11.vercel.app' },
];
      ...
      <div style={{ width: '100%', maxWidth: '900px' }}>
        ...
        <div className="contact-grid">
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate="visible">
            <p style={{ marginBottom: '18px', fontSize: '0.75rem', color: 'var(--text-muted)', fontFamily: 'Inter', lineHeight: '1.85' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {CONTACT_LINKS.map(({ label, value, Icon, href }) => (
                <motion.a key={label} href={href} target="_blank" rel="noreferrer"
                  variants={cardItem} className="glass-card teal-glow-border" data-cursor
                  ...
                  <div style={{
                    ...
                    <Icon size={15} color="var(--primary-teal)" strokeWidth={1.75} />
                  </div>
                  <div>
                    ...
                    <div style={{ fontSize: '0.72rem', color: 'var(--text-secondary)', fontFamily: 'Inter' }}>{value}</div>
                  </div>
                </motion.a>
              ))}
            </div>

            <motion.div variants={fadeInUp} style={{ marginTop: '14px', padding: '12px 16px', background: 'rgba(45,212,191,0.05)', border: '1px solid rgba(45,212,191,0.18)', borderRadius: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
              <Radio size={14} color="var(--primary-teal)" strokeWidth={2} style={{ animation: 'statusBlink 2s ease-in-out infinite', flexShrink: 0 }} />
              <span style={{ fontSize: '0.62rem', letterSpacing: '0.1em', color: 'var(--text-secondary)', fontFamily: 'Inter', fontWeight: '500' }}>
          ...
          <motion.div variants={fadeInUp} initial="hidden" animate="visible" transition={{ delay: 0.2 }}>
            <div className="glass-card" style={{ padding: '28px', borderRadius: '16px' }}>
              <div style={{ marginBottom: '22px', fontSize: '0.6rem', letterSpacing: '0.2em', color: 'var(--primary-teal)', textTransform: 'uppercase', fontWeight: '600' }}>Send a Message</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '22px' }}>
                ...
                <button className="btn-teal" onClick={handleSubmit} data-cursor
