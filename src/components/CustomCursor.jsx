  ...
  return (
    <>
      <div ref={dotRef} style={{
        width: '7px', height: '7px', background: 'var(--primary-white)', borderRadius: '50%',
        position: 'fixed', top: 0, left: 0, pointerEvents: 'none', zIndex: 9999,
        transform: 'translate(-50%,-50%)',
        boxShadow: '0 0 10px var(--primary-white), 0 0 22px rgba(255,255,255,0.3)',
        transition: 'transform 0.1s ease',
      }} />
      <div ref={ringRef} style={{
        width: isHovering ? '52px' : '36px',
        height: isHovering ? '52px' : '36px',
        border: `1.5px solid ${isHovering ? 'var(--primary-white)' : 'rgba(255,255,255,0.4)'}`,
