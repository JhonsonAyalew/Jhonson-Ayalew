    ...
    <motion.div variants={pageTransition} initial="hidden" animate="visible" exit="exit"
      ...
      <div className="detail-grid section-pad" style={{ maxWidth:'980px' }}>
        <motion.div variants={slideLeft}>
          ...
          <h1 style={{ fontFamily:'Orbitron', fontSize:'clamp(1.6rem,3.5vw,2.8rem)', lineHeight:1, color:'var(--text-primary)', marginBottom:'16px' }}>{detail.title}</h1>
          <div className="glass-card" style={{ padding:'22px' }}>
            <p style={{ fontFamily:'Rajdhani',  fontSize:'0.98rem', color:'var(--text-secondary)', lineHeight:'1.7' }}>{detail.content}</p>
          </div>
          <button onClick={onBack} data-cursor
            style={{ marginTop:'16px', background:'none', border:'1px solid var(--border-subtle)', color:'var(--text-muted)', fontFamily:'Share Tech Mono', fontSize:'0.52rem', letterSpacing:'0.14em', padding:'8px 16px', cursor:'none', transition:'all 0.25s' }}
